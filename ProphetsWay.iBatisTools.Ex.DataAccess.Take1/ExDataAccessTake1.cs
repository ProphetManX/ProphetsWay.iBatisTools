...
using ProphetsWay.iBatisTools.Ex.DataAccess.Take1.Daos;
...
namespace ProphetsWay.iBatisTools.Ex.DataAccess.Take1
{
	public class ExDataAccessTake1 : BaseDataAccess<int>, IExampleDataAccess
	{
